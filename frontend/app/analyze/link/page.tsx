...
export default function LinkAnalyzePage() {
  ...
  const analyzeLink = async () => {
    ...
    try {
      ...
      setError(
        "Failed to connect to backend link analyzer. Ensure backend is running on port 8000.",
      );
      console.error(err);
    } finally {
  ...
  const handleGoogleCompare = () => {
    const targetUrl = (result?.url || url || "").trim();
    if (!targetUrl) {
      setError("Enter a URL to verify with Google.");
      return;
    }

    // Detect scam language from URL
    const langResult = detectScamLanguage(targetUrl);
    setScamLanguageResult(langResult);

    const searchQuery = `is ${targetUrl} fraud scam phishing website`;
        ...
        <Card className="max-w-4xl mx-auto p-8 mb-8 border-2">
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={isAnalyzing || (!result && !url.trim())}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="p-4 border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/30">
                ...
                <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
                  Instant reputation analysis with Google verification lookup.
                </p>
              </Card>
              ...
              <Card className="p-4 border-2 border-green-200 dark:border-green-800 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/30 dark:to-green-900/30">
                ...
                <p className="text-xs text-green-700 dark:text-green-300 mt-1">
                  Analyzes top-level domains and shortener patterns for fraud.
                </p>
              </Card>
              ...
              <Card className="p-4 border-2 border-purple-200 dark:border-purple-800 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/30 dark:to-purple-900/30">
                ...
                <p className="text-xs text-purple-700 dark:text-purple-300 mt-1">
                  ML-powered detection of urgency and phishing patterns.
                </p>
              </Card>
            </div>
          </div>
